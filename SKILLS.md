...
|---|---|---|---|---|---|---|---|
| code-review | `~/.agents/skills/code-review` | [mattpocock/skills](https://github.com/mattpocock/skills) | 并行进行规范与需求符合性审查 | `3cca18b` | 仓库子目录 `skills/engineering/code-review`；按子目录差异更新 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
| codebase-design | `~/.agents/skills/codebase-design` | [mattpocock/skills](https://github.com/mattpocock/skills) | 深模块设计与接口边界方法 | `3cca18b` | 仓库子目录 `skills/engineering/codebase-design`；按子目录差异更新 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
...
| domain-modeling | `~/.agents/skills/domain-modeling` | [mattpocock/skills](https://github.com/mattpocock/skills) | 建立领域术语、模型和架构决策 | `3cca18b` | 仓库子目录 `skills/engineering/domain-modeling`；按子目录差异更新 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
...
| grill-me | `~/.agents/skills/grill-me` | [mattpocock/skills](https://github.com/mattpocock/skills) | 通过连续追问打磨方案 | `3cca18b` | 仓库子目录 `skills/productivity/grill-me`；更新前处理现有冲突副本 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
| grill-with-docs | `~/.agents/skills/grill-with-docs` | [mattpocock/skills](https://github.com/mattpocock/skills) | 在方案追问时同步沉淀领域文档 | `3cca18b` | 仓库子目录 `skills/engineering/grill-with-docs`；更新前处理现有冲突副本 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
...
| grilling | `~/.agents/skills/grilling` | [mattpocock/skills](https://github.com/mattpocock/skills) | 对计划或设计逐项压力测试 | `3cca18b` | 仓库子目录 `skills/productivity/grilling`；按子目录差异更新 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
| implement | `~/.agents/skills/implement` | [mattpocock/skills](https://github.com/mattpocock/skills) | 根据 spec 或 tickets 实施工作 | `3cca18b` | 仓库子目录 `skills/engineering/implement`；按子目录差异更新 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
...
| prototype | `~/.agents/skills/prototype` | [mattpocock/skills](https://github.com/mattpocock/skills) | 用一次性原型验证业务逻辑、状态模型或 UI 方案 | `3cca18b` | 仓库子目录 `skills/engineering/prototype`；按子目录差异更新 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
| setup-matt-pocock-skills | `~/.agents/skills/setup-matt-pocock-skills` | [mattpocock/skills](https://github.com/mattpocock/skills) | 初始化工程 skills 所需项目配置 | `3cca18b` | 仓库子目录 `skills/engineering/setup-matt-pocock-skills`；更新前处理现有冲突副本 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
...
| tdd | `~/.agents/skills/tdd` | [mattpocock/skills](https://github.com/mattpocock/skills) | 测试驱动开发工作流 | `3cca18b` | 仓库子目录 `skills/engineering/tdd`；按子目录差异更新 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
| teach | `~/.agents/skills/teach` | [mattpocock/skills](https://github.com/mattpocock/skills) | 在工作区内持续教授概念或技能 | `3cca18b` | 仓库子目录 `skills/productivity/teach`；更新前处理现有冲突副本 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
| to-spec | `~/.agents/skills/to-spec` | [mattpocock/skills](https://github.com/mattpocock/skills) | 将对话综合为可执行 spec | `3cca18b` | 仓库子目录 `skills/engineering/to-spec`；按子目录差异更新 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
| to-tickets | `~/.agents/skills/to-tickets` | [mattpocock/skills](https://github.com/mattpocock/skills) | 将方案拆成带依赖关系的 tickets | `3cca18b` | 仓库子目录 `skills/engineering/to-tickets`；按子目录差异更新 | Codex、Claude Code、Cursor、Grok | 2026-09-05 |
